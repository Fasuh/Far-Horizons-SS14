...
public sealed class LightDebugOverlay : Robust.Client.Graphics.Overlay
{
    ...
    private List<(Entity<MapGridComponent>, LightOverlayGridData)> _grids = new();
    ...
    private void DrawData(LightOverlayGridData msg, DrawingHandleWorld handle)
    {
        var baseIdx = msg.BaseIdx;
        var range = LightDebugOverlaySystem.LocalViewRange;
